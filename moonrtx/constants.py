...
FLIP_HORIZONTAL_VIEW_ORIENTATIONS = [VIEW_ORIENTATION_NSEW, VIEW_ORIENTATION_SNEW]
FLIP_VERTICAL_VIEW_ORIENTATIONS = [VIEW_ORIENTATION_SNEW, VIEW_ORIENTATION_SNWE]
