...
class MainWindow(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Label(frm, text="Latitude:").grid(row=0, column=0, sticky=tk.W, pady=2)
        tk.Label(frm, text="Longitude:").grid(row=1, column=0, sticky=tk.W, pady=2)
        tk.Label(frm, text="Time:").grid(row=2, column=0, sticky=tk.W, pady=2)
        tk.Label(frm, text="Elevation file:").grid(row=3, column=0, sticky=tk.W, pady=2)
        tk.Label(frm, text="Downscale:").grid(row=4, column=0, sticky=tk.W, pady=2)
        tk.Label(frm, text="Brightness:").grid(row=5, column=0, sticky=tk.W, pady=2)
        tk.Label(frm, text="Init view:").grid(row=6, column=0, sticky=tk.W, pady=2)
