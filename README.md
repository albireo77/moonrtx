...
- If you don't like default Moon colors, you can download file with more realistic colors (though bland) from [NASA site](https://svs.gsfc.nasa.gov/4720). Then load it with `--color-file` program parameter.
