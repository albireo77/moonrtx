...
This export (using NVENC encoder available on PlotOptiX level) gives high quality (noise-free and without stuttering) output but as video is not captured but generated by renderer, it takes considerable amount of time to create.
