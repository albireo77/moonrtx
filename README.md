...
- If you don't like default Moon colors in MoonRTX, you can download file (e.g. [lroc_color_poles.tif](https://svs.gsfc.nasa.gov/vis/a000000/a004700/a004720/lroc_color_poles.tif) from [NASA SVS CGI Moon Kit](https://svs.gsfc.nasa.gov/4720) with more realistic, though bland, colors) and load it with `--color-file` parameter on program start.
