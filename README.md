...
**and sunset, exported to MP4 file using V key**  
[![Sunset](https://img.youtube.com/vi/C44osfLSB9Y/maxresdefault.jpg)](https://www.youtube.com/watch?v=C44osfLSB9Y)  
This export uses PlotOptiX's hardware-accelerated NVENC encoder producing high quality (noise-free, no stuttering) video. As it is not captured but generated by renderer, exporting takes considerably longer than real time.  
