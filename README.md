...
- If you don't like default color file, you can download more realistic one from [NASA site](https://svs.gsfc.nasa.gov/4720). Then load it with `--color-file` program parameter.
