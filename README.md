...
- On first Moon ephemeris calculation, MoonRTX may download a small Skyfield data set into `skyfield_data/`: the JPL `de421.bsp` ephemeris (about 16 MB) plus three small Moon orientation kernels used for the direct lunar body-frame rotation.
